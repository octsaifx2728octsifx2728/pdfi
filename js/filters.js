...
var filters_c={
    ...
    init:function($){
        ...
        this.filter=$(this).find(".filter").each(function(i){
            ...
            $(this).find(".field").hover(function(){
                var cont =0;
...
$(document).ready(function(){
    ...
    var filaux = $(".searchFilter").find(".filter.filter_tipoinmueble");
    var v = null;
    $(filaux).find(".field").each(function(x){
        v = this;  
    });

    $(v).css("border-bottom", "1px solid #ccc");
