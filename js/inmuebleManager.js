	...
	productChanged:function(id){
        ...
        showProduct:function(respuesta,id){
            ...
            if(respuesta.error=="0"&&respuesta.datos){
                var div='<div class="section pago"><div class="producto productoid_'+respuesta.datos.id+' standar module3"><div class="wrap cabecera">'+respuesta.datos.nombre+'</div><div class="wrap2"><div class="product standar module2"><div class="wrapSFX"><div class="label productid_'+respuesta.datos.id+' inmueble_'+respuesta.datos.inmueble+'  inmuebletipo_'+respuesta.datos.inmuebleTipo+'"><div class="titleTratoCerrado">'+respuesta.datos.descripcion+'<br>$ '+respuesta.datos.precio+' USD</div><div class="des"></div></div></div></div></div></div></div>';
