...
class oficina_inmueble extends inmueble{
    public $nombreS='$$oficina$$';
    public $nombreP='$$oficinas$$';
    public $typename="oficina";
    public $linktext='$$ver_esta_oficina$$';
  ...
  protected $_meinteresa=array(
      ...
      "tipovrventa"=>array(
            "default"=>'$$meinteresacompraroficina$$'
          ),
      "tipovrrenta"=>array(
            "default"=>'$$meinteresarentaroficina$$'
          ),
      "tipovrcomparto"=>array(
            "default"=>'$$meinteresacompartiroficina$$'
          )
  );
    ...
    public $typeid=3;
    public $description='$$oficina_description$$';
    protected $_fieldsBasic=array(
                ...
                array(
                    ...
                    "ranges"=>array(
                            "tipovrventa"=>array(0,5000),
                            "tipovrrenta"=>array(0,5000),
                            "tipovrcomparto"=>array(0,5000)
                        )
                    ),
                array(
                    "name"=>"m2s",
    ...
    protected $_itemsGeneral=array(
        ...
        "comedor"=>array("nombre"=>'$$comedor$$'),
        "lounge"=>array("nombre"=>'$$lounge$$'),
        "recepcion"=>array("nombre"=>'$$recepcion$$'),
        "impresora"=>array("nombre"=>'$$impresora$$'),
        "s24h"=>array("nombre"=>'$$s24h$$'),
        "valet"=>array("nombre"=>'$$valet$$'),
        "limpieza"=>array("nombre"=>'$$limpieza$$'),
        "licencias"=>array("nombre"=>'$$licencias$$'),
        );
    public function oficina_inmueble($id_expediente){
