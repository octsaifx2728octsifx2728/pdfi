        ...
        if(respuesta.error=="0"){
           ...
           /* if(this.editID>0){
            ...
            for(var i=0;i<respuesta.form.length;i++){
                ...
                var control="<div class='control'><input type='button' value='"+respuesta.okText+"' class='submit'><input class='cancel' type='button' value='"+respuesta.cancelText+"'></div>";
        ...
        if(this.pretend.gratis){
            ...
            if(this.pretend.product){
                var div="<div class='producto standar module3'>"+
                    "<div class='wrap cabecera'>"+enviroment.translations.anuncioFreemium+"</div>"+
                    "<div class='wrap2'><div class='product standar module2'>"+
                    "<div class='wrap'><div class='label'><div class='title'>"+this.pretend.product.nombre+"</div>"+
              ...
              $(this).find(".submitPago").append(div);
              var btnPrem = "<div class='productPrem standar module2'><div class='wrap'><div class='label'><div class='title'>"+enviroment.translations.btnPremium+"</div></div></div></div>";
              ...
              $(this).find(".productoPremium").find(".label").click(function(){
                    //$(this).find(".submitPago").show();
                //$.colorbox({open:true,html:"<p>hello</p>"             });
                //
                
                //var div='<div class="section pago"><div class="producto productoid_'+1111+' standar module3"><div class="wrap cabecera">'+1111+'</div><div class="wrap2"><div class="product standar module2"><div class="wrap"><div class="label productid_'+1111+' inmueble_'+1111+'  inmuebletipo_'+111+'"><div class="title">'+1111+'<br>$ '+111+' USD</div><div class="des"></div></div></div></div></div></div></div>';
                //$(".formasdepago").append(div);
